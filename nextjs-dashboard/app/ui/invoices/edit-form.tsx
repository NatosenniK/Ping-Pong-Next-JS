    ...
    <form action={formAction}>
      <div className="rounded-md bg-gray-50 p-4 md:p-6 dark:bg-slate-700">
        ...
        <fieldset>
          ...
          <div className="rounded-md border border-gray-200 bg-white px-[14px] py-3 dark:bg-slate-800 dark:text-white">
            <div className="flex gap-4">
              <div className="flex items-center">
                <input
                  ...
                  className="h-4 w-4 cursor-pointer border-gray-300 bg-gray-100 text-gray-600 focus:ring-2 dark:bg-slate-800 dark:text-slate-800"
                />
                <label
                  htmlFor="pending"
